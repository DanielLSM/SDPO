...
def _flatten_record(config: OracleRunConfig, seed: int, record: dict[str, Any]) -> dict[str, Any]:
    ...
    row: dict[str, Any] = {
        ...
        "best_arm": record.get("best_arm", instance.best_arm),
        "best_arm_label": record.get("best_arm_label", labels[instance.best_arm]),
        ...
        "predicted_forward_decrement": (
            record["predicted_forward_decrement"] if record["predicted_forward_decrement"] is not None else ""
        ),
